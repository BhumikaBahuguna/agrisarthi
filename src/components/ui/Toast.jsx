 ...
 * @param {Function} props.onClose - Function called to close the toast
 * @param {number} [props.duration=3000] - Duration in ms before auto-closing (0 for no auto-close)
 */
const Toast = ({ message, type = 'info', isVisible, onClose, duration = 3000 }) => {
  ...
  const typeStyles = {
    success: 'bg-leaf-500 text-white dark:bg-leaf-600',
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex items-center shadow-lg rounded-lg overflow-hidden animate-slide-up">
      <div className={`flex items-center px-4 py-3 ${typeStyles[type]}`}>
        {icons[type]}
